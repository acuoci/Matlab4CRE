...
pAout = (1-0.85)*pAin;  % first guess solution (from co-current)
for i=1:maxiterations
    
    % ODE solution
    Yin = [pAout CBin CCin]';
    [V, Y] = ode45(@TowerCounterCurrent, [0 Vtot], Yin);
    pA = Y(:,1);
...
% ------------------------------------------------------------------------%
function dY = TowerCounterCurrent(V,Y)
    ...
    [r,E] = OverallRateOfChange(pA, CB);    % [kmol/m3/s]
