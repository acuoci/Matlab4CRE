...
y = fsolve(@adiabaticPFR, yFirstGuess);

fprintf('Solution: X=%f, T=%f C', y(1), y(2)-273.15);


% ------------------------------------------------------------------------%
% NL system (defined locally, requires at least MATLAB-2016b)             %
% ------------------------------------------------------------------------%
function F = adiabaticPFR(y)
